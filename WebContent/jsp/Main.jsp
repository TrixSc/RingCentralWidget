...
<head>
	...
	<script type="text/javascript" src="https://localhost:4443/lib/EmbeddedAppInterface.js"></script>
	<script type="text/javascript" src="https://localhost:4443/lib/ZohoCrmHelper.js"></script>

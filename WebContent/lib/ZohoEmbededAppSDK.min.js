...
a.events;if(b(e))for(temp in e)this.events[temp]&&(this.events[temp]=e[temp]);a=a.customEvents;if(b(a))for(temp in a)this.customEvent[temp]=a[temp]}},request:function(a){var e=Math.random().toString(36).substr(2,16);window.parent.postMessage({WidgetID:d,CallBackID:e,Data:a},"https://crmplugins.zoho.com");var c;a=new Promise(function(a,e){c=a});callBackMap[e]={promise:c};return a},handleEvent:function(a){"Config"==a.data.type?d=a.data.config.widgetID:this.handleMsg(a.data)},handleMsg:function(a){var e=
